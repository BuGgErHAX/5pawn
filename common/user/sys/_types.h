...
typedef	int64_t	__darwin_blkcnt_t;	/* total blocks */
typedef	int32_t	__darwin_blksize_t;	/* preferred block size */
typedef int32_t	__darwin_dev_t;		/* dev_t */
...
typedef uint32_t	__darwin_gid_t;		/* [???] process and group IDs */
typedef uint32_t	__darwin_id_t;		/* [XSI] pid_t, uid_t, or gid_t*/
typedef uint64_t	__darwin_ino64_t;	/* [???] Used for 64 bit inodes */
#if __DARWIN_64_BIT_INO_T
typedef __darwin_ino64_t __darwin_ino_t;	/* [???] Used for inodes */
#else /* !__DARWIN_64_BIT_INO_T */
typedef __uint32_t	__darwin_ino_t;		/* [???] Used for inodes */
#endif /* __DARWIN_64_BIT_INO_T */
typedef int darwin_natural_t;
darwin_natural_t __darwin_mach_port_name_t; /* Used by mach */
typedef int darwin_mach_port_name_t;
darwin_natural_t __darwin_mach_port_t; /* Used by mach */
typedef uint16_t	__darwin_mode_t;	/* [???] Some file attributes */
typedef int64_t	__darwin_off_t;		/* [???] Used for file sizes */
typedef int32_t	__darwin_pid_t;		/* [???] process and group IDs */
...
typedef uint32_t	__darwin_sigset_t;	/* [???] signal set */
typedef int32_t	__darwin_suseconds_t;	/* [???] microseconds */
typedef uint32_t	__darwin_uid_t;		/* [???] user IDs */
typedef uint32_t	__darwin_useconds_t;	/* [???] microseconds */
